...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} w-full flex items-center py-3 fixed top-0 z-20 bg-primary cursor-pointer`}
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto my-3">
        ...
        >
          ...
          <p className="flex text-white tracking-wider text-[18px] font-bold cursor-pointer">
            Maaz | Portfolio
          </p>
        </Link>
